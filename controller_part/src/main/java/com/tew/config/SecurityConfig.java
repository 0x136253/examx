...
import com.tew.component.JwtAuthenticationTokenFilter;
import com.tew.component.RestAuthenticationEntryPoint;
import com.tew.component.RestfulAccessDeniedHandler;
...
//                        "/","/*",
                ...
                .antMatchers("/ROLE_SYSTEM").hasRole("SYSTEM")
    ...
    public UserDetailsService userDetailsService() {
        ...
        return username -> {
            ...
            if (admin != null) {
                return new AdminUserDetails(admin,permissDAO.selectById(admin.getId()));
            }
